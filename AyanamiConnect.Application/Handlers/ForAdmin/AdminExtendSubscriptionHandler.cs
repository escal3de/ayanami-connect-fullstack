...
namespace AyanamiConnect.Application.Handlers.ForAdmin;

public class AdminExtendSubscriptionHandler(
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var operationResult = BalanceOperation.Create(
                BalanceOperationKind.System,
                "Админская выдача подписки",
                0m,
                $"Ручная выдача {GetPlanLabel(plan)}.");
